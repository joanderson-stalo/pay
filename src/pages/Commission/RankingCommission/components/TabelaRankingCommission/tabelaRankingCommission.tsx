...
export function TabelaRankingCommission({ commissions_by_EC }: TabelaProps) {
  ...
  return (
    <S.Table>
      <thead>
        <tr>
          <S.TableHeader onClick={() => handleSort('nome')}>Licenciado<SortIndicator direction={getDirectionForField('nome')} /></S.TableHeader>
